  ...
  const steps = [
    {
      ...
      title: "Your business",
      description: "Done — we saved this when you signed up.",
      estimate: null,
      optional: false,
    ...
    },
    {
      ...
      description: "Pick the days and times you want to take bookings.",
      estimate: "1 min",
      optional: false,
    ...
    },
    {
      ...
      description: "List your services so customers can book one.",
      estimate: "2 min",
      optional: false,
    ...
    },
    {
      ...
      title: "Take deposits",
      description: "Stop no-shows by asking for money upfront.",
      estimate: "1 min",
      optional: true,
    ...
    },
    {
      ...
      description: "Get your link and post it where customers can click.",
      estimate: "1 min",
      optional: false,
