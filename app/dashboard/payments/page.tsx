...
export default function PaymentsPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      {requireDeposit && !methods.stripe?.enabled && !methods.square?.enabled && !methods.paypal?.enabled && !methods.cashapp?.enabled && !methods.bankTransfer?.enabled && !methods.cash?.enabled && (
