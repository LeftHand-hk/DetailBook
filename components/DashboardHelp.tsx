...
export default function DashboardHelp({ page }: { page: PageKey }) {
  ...
  // booking-page has a sticky autosave bar at bottom-0 (~52px) that would
  // hide the lower half of this button. Lift the button above it.
  const hasStickyBar = pathname === "/dashboard/booking-page";
  const bottomPx = hasStickyBar ? 24 + 56 : 24;
